...
| # | Decision | Covers |
|---|---|---|
| [0001](0001-what-standup-reads-and-what-it-keeps.md) | What Standup reads, what it keeps, and what time means | Scan Universe; retired Checkpoint and the Recent Window; Derived Cache and the durable-root split; `--since` as the only knob; ageless attribution; one module owns the scan (Repo Entry identity, cache lifecycle) |
