...
| [0004](0004-the-watch.md) | The Watch | event source; stream/UI boundary; discovery vs the constructor (and the types the UI reads); motion never outliving data; Activity State; Change Runs; removed-row field; fold vs clip; selection in the lane; mouse gestures |
