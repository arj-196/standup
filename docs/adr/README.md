...
| [0004](0004-the-watch.md) | The Watch | event source; stream/UI boundary and the row model on its Textual-free side; motion never outliving data; Activity State; Change Runs; removed-row field; fold vs clip; selection in the lane; mouse gestures |
